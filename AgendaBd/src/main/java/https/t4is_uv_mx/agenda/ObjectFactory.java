...
public class ObjectFactory {
    ...
    private final static QName _BuscarRegistrosRequest_QNAME = new QName("https://t4is.uv.mx/agenda", "BuscarRegistrosRequest");
    ...
    /**
     * Create an instance of {@link RegistarEntradaRequest }
     * 
     */
    public RegistarEntradaRequest createRegistarEntradaRequest() {
        return new RegistarEntradaRequest();
    }

    /**
     * Create an instance of {@link RegistarEntradaResponse }
     * 
     */
    public RegistarEntradaResponse createRegistarEntradaResponse() {
        return new RegistarEntradaResponse();
    }

    /**
     * Create an instance of {@link BuscarRegistrosResponse.Agenda }
     * 
     */
    public BuscarRegistrosResponse.Agenda createBuscarRegistrosResponseAgenda() {
        return new BuscarRegistrosResponse.Agenda();
    }
     ...
     */
    @XmlElementDecl(namespace = "https://t4is.uv.mx/agenda", name = "BuscarRegistrosRequest")
